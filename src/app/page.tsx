             ...
             <section className="py-20 md:py-24">
              <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <Image src="https://raw.githubusercontent.com/Gagansidh-u/Images/main/e7511167-627d-4861-8b8b-499f5bf1e01e.jpeg?raw=true" alt="Anime character" width={400} height={600} sizes="(max-width: 768px) 50vw, 25vw" className="rounded-lg object-cover w-full h-[70%] row-span-2 hover:scale-105 transition-transform duration-300" />

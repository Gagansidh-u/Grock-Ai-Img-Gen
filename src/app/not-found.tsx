...
export default function NotFoundPage() {
  ...
  const background = useTransform(
    [mouseX, mouseY],
    ([x, y]) => `radial-gradient(800px circle at ${x * 100}% ${y * 100}%, hsla(var(--primary), 0.25), transparent 40%)`
  );
    ...
    >
       {isClient ? (
        ...
        <div className="relative z-10 flex flex-col items-center">
            <h1 className="text-[12rem] font-extrabold tracking-tighter text-primary md:text-[16rem]">404</h1>
            <h2 className="-mt-12 text-2xl font-semibold text-foreground md:-mt-16 md:text-4xl">
              Page Lost in Space
            </h2>

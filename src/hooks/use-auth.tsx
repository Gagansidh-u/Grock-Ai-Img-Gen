...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const handleUserVerification = async (user: User, displayName?: string | null): Promise<UserProfile | null> => {
    ...
    } else if (!userProfile.plan || !userProfile.hasOwnProperty('monthlyImageCredits') || !userProfile.hasOwnProperty('dailyImageCredits') || !userProfile.hasOwnProperty('apiKey')) {
